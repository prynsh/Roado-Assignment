...
export const BottomCard = ({ title, loadNumber, billTo, date, concernText, thermometerIcon }: DriverConcernProps) => {
    return (
        <div className="border border-gray-300 rounded-lg p-4 m-4 bg-white shadow-sm">
            <div className="flex justify-between items-center mb-4">
                <div className="flex items-center">
            ...
            <div className="flex justify-end">
                <button className="px-4 py-2 mx-7 underline text-blue-950 rounded-md">Ignore</button>
                <button className="px-4 py-2 bg-indigo-900 text-white rounded-md">Resolve</button>
            </div>
        </div>
    );
